      ...
      <table cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr>
          <td class="main_cont__slider__item__text" width="100%">
            ...
            <i class="br30"></i>
            <a onclick="yaCounter36726625.reachGoal('MAINDONATE');" href="<?php echo url_for('@donate'); ?>" class="btn_all blue_btn btn_all_middle fs_18">Поддержать проект</a>
          </td>
      ...
      <table cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr>
          <td class="main_cont__slider__item__text" width="100%">
            ...
            <i class="br20"></i>
            <a onclick="yaCounter36726625.reachGoal('MAINASK');" href="<?php echo url_for('@ask_question'); ?>" class="btn_all green_btn btn_all_middle fs_18">Задать вопрос</a>
          </td>
