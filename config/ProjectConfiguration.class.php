...
class ProjectConfiguration extends sfProjectConfiguration
{
  ...
  {
    //var_dump($manager->getCurrentConnection()->getName());
    
    
    //$manager->setCurrentConnection('bnp');
    ...
    $manager->setAttribute(Doctrine_Core::ATTR_RESULT_CACHE, new Doctrine_Cache_Memcache(array(
      'servers' => $servers,
      'compression' => false,
      'prefix' => str_replace('/', '_', __DIR__)
    )));
