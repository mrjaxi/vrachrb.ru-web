 ...
 */
class CreateAnalysisForm extends BaseAnalysisForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['photo'] = new sfWidgetFormInputFileUpload(array('allowedFileTypes' => 'image/png,image/jpeg', 'script' => '/uploader?key=analysis', 'multiple' => false, 'emulateUpload' => true), array('required' => true));
