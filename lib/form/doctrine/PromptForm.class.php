 ...
 */
class PromptForm extends BasePromptForm
{
  public function configure()
  {
    $this->useFields(array('specialist_id', 'specialty_id', 'title', 'photo', 'video', 'created_at', 'description', 'body'));
    ...
    $this->widgetSchema['photo'] = new sfWidgetFormInputFileUpload(array('allowedFileTypes' => 'image/png,image/jpeg', 'script' => '/uploader?key=prompt', 'multiple' => false, 'jcrop' => true), array('required' => true));
    ...
    $this->validatorSchema->setPostValidator(new sfValidatorAnd(array(
      ...
      new sfValidatorDoctrineUnique(array('model'=> 'Prompt','column'=> 'title_url')),
    )));
  }
}
