...
class csSettingAdminForm extends csSettingForm
{
  ...
  { 
    $this->useFields(array('name', 'type', 'widget_options', 'value', 'setting_group', 'setting_default', 'slug'));

    $this->widgetSchema['name'] = new sfWidgetFormInputText(array('label' => 'Название'), array('size' => 60));
    $this->widgetSchema['type'] = new sfWidgetFormSelectRadio(array('choices' => sfConfig::get('app_csSettingsPlugin_types'),));
    $this->widgetSchema['widget_options'] = new sfWidgetFormInputText(array('label' => ''), array('size' => 80));
    $this->widgetSchema['setting_default'] = new sfWidgetFormInputText(array('label' => ''), array('size' => 80));
    $this->widgetSchema['slug'] = new sfWidgetFormInputText(array('label' => ''), array('size' => 80));
    ...
    if ($choices)
    {
      ...
      $this->widgetSchema['setting_group'] = new sfWidgetFormSelect(array('choices' => $choices,));
    }
