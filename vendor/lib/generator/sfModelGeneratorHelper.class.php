...
abstract class sfModelGeneratorHelper
{
  ...
  {
    return '<li class="sf_admin_action_new">' . link_to(__($params['label'], array(), 'sf_admin'), '@'.$this->getUrlForAction('new'), isset($params['class']) ? array('class' => $params['class']) : array()) . '</li>';
  }
