    ...
    if ($form->isValid())
    {
      ...
      else
      {
        if(!$request->isXmlHttpRequest())
        {
          ...
          $this->redirect($request->hasParameter('return') ? $request->getParameter('return') : array('sf_route' => '<?php echo $this->getUrlForAction('edit') ?>', 'sf_subject' => $<?php echo $this->getSingularName() ?>));
        }
      }
    }
    else
